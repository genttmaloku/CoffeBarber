                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            <div className="shrink-0 flex items-center justify-start">
                                <Link href="/">
<img src="/images/logo-min.png" className='h-5' alt="" />
</Link>
                            </div>
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center transition duration-200 ease-in-out px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-blue-300 bg-gray-700 hover:text-blue-500 focus:outline-none transition ease-in-out duration-150"
                                            >
                                                {user.name}
